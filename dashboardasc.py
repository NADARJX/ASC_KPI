...
user_roles = {
    "ASCMAY": {"division": "Derma Magna", "email": "venkateshbabu.pr@abbott.com"},
    "ASCMAY1": {"division": "Derma Prime", "email": "arijit.gupta@abbott.com"},
    "ASCMAY2": {"division": "CCD Cordis", "email": "basheer.ahmed@abbott.com"}
}
